...
function StaffFormModal({ onClose, onSave, staff, servicesList, staffList }: { onClose: () => void; onSave: (s: Staff, assignedServiceIds: string[]) => void; staff?: Staff; servicesList: Service[]; staffList: Staff[] }) {
  ...
  const handleSave = () => {
    ...
    const colors = ["#F97316", "#f472b6", "#34d399", "#fb923c", "#38bdf8", "#ec4899", "#f59e0b", "#6366f1"];
              ...
              {servicesList.length > 0 ? servicesList.map((sv) => {
                ...
                return (
                  <div key={sv.id} onClick={() => toggleService(sv.id)} style={{ display: "flex", alignItems: "center", gap: 10, padding: "6px 8px", borderRadius: 6, cursor: "pointer", background: checked ? "#f4f0fe" : "transparent" }}>
                    <div style={{ width: 16, height: 16, borderRadius: 4, border: "1px solid #EA580C", display: "flex", alignItems: "center", justifyContent: "center", background: checked ? "#EA580C" : "#fff" }}>
        ...
        records.push({
          ...
          staff: {
            ...
            section: String(row["Section"] ?? row["section"] ?? "").trim()
              ...
              || undefined,
            specialties,
            color: String(row["Color"] ?? row["color"] ?? "").trim() || existingStaff?.color || "#F97316",
        ...
        {step === "preview" && (
          <>
            ...
            <div style={{ display: "flex", gap: 10, marginTop: 18 }}>
              ...
              <button onClick={confirmImport} disabled={parsed.length === 0} style={{ flex: 2, padding: "10px 0", borderRadius: 10, border: "none", background: parsed.length ? "#EA580C" : "#e8e8f0", fontSize: 13, fontWeight: 700, color: parsed.length ? "#fff" : "#b0b0c8", cursor: parsed.length ? "pointer" : "not-allowed" }}>Import Staff</button>
            </div>
          </>
        )}
  ...
  return (
    <div className="dash-page dashboard-polish" style={{ background: "#ffffff", minHeight: "100vh", display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      <div className="dashboard-topbar page-header" style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <PageTitle
          ...
          subtitle={
            ...
            <span style={{ marginLeft: 8, color: "#b0b0c8", fontWeight: 700 }}>· {activeCount} active</span>
            </>
          }
        />
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
      ...
      {getActiveSection() !== "all" ? (
        <div style={{ display: "flex", alignItems: "center", gap: 8, alignSelf: "flex-start", padding: "8px 14px", borderRadius: 12, background: "#fff7ed", border: "1px solid #fed7aa" }}>
          ...
          return (
            ...
            >
              ...
              <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                  ...
                  <button
                    ...
                    style={{ width: 28, height: 28, borderRadius: 8, border: "1px solid #FFEDD5", background: "#FFF7ED", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", transition: "all 0.15s" }}
                    className="hover-bg-light"
                  >
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr auto", gap: 8, borderTop: "1px solid #f8f8fc", paddingTop: 14, alignItems: "center" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "center", width: 28, height: 28, borderRadius: "50%", background: "#fff1e3", transition: "transform 0.15s" }} className="hover-scale">
